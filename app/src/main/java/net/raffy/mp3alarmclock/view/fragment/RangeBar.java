package net.raffy.mp3alarmclock.view.fragment;
...
public class RangeBar extends FrameLayout {
    ...
    private final ImageView min= (ImageView)findViewById(R.id.range_bar_min);
    private final ImageView max= (ImageView)findViewById(R.id.range_bar_max);
    private final ImageView progress = (ImageView)findViewById(R.id.range_bar_progress);
...
/*
    public RangeBar(Context c, AttributeSet a, int i) {
        this(c, a, 0);
    }
