package net.raffy.morningDrone.morning_drone;
...
import net.raffy.morningDrone.bluetooth_LE_GATT.DeviceControlActivity;
...
public class Bluetooth2 extends DeviceControlActivity //DeviceScanActivity
    {
