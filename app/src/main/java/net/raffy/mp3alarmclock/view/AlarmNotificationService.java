...
import net.raffy.mp3alarmclock.view.activity.AlarmClockProvider;
import net.raffy.mp3alarmclock.view.activity.AlarmNotificationActivity;
import net.raffy.mp3alarmclock.view.activity.DbUtil;
import net.raffy.mp3alarmclock.view.activity.MainActivity;
                    ...
                    switch (m.what) {
                        case TRIGGER_INC:
                            float inc = s.volume_time > 0 ?
                                    ...
                                    s.volume_ending;
                            float next; int n=1;
                            next = Math.min(/*(float) m.obj*/n + inc, s.volume_ending);
