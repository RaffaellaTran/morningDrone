package net.raffy.mp3alarmclock.morning_drone;


import android.app.DialogFragment;

/**
 * Created by raffy on 25/04/17.
 */
   ...
   /* @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final boolean has_external = PackageManager.PERMISSION_GRANTED ==
                getContext().checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE,Process.myPid(), Process.myUid());
